...
namespace DDD.MVC.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IClientProductAppService>().To<ClientProductAppService>();
            kernel.Bind<IProductAppService>().To<ProductAppService>();

            kernel.Bind(typeof(IServiceBase<>)).To(typeof(ServiceBase<>));
            kernel.Bind<IClientService>().To<ClientService>();
            kernel.Bind<IClient_ProductService>().To<Client_ProductService>();
            kernel.Bind<IProductService>().To<ProductService>();

            kernel.Bind(typeof(IRepositoryBase<>)).To(typeof(RepositoryBase<>));
            kernel.Bind<IClientRepository>().To<ClientRepository>();
            kernel.Bind<IClient_ProductRepository>().To<Client_ProductRepository>();
